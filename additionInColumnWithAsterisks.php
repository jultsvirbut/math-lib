...
//выводит массив elements - цифр слагаемых и суммы, с вставленными звездочками
//выводит массив solutions - где каждый элемент, строчка решения-обьяснения нахождения каждой звездочки

$elements = $solutions = array();

function AdditionInColumnWithAsterisks () {
...
//PrintSolutionAdditionInColumnWithAsterisks ()
echo '<pre>';
print_r($solutions[$j]);
echo '</pre>';


//преобразование elements и вывод условия
//PrintAdditionInColumnWithAsterisks()
